...
25) 화물 </br>
      - 장착 슬롯 : 마차에 싣는다. - 슬롯의 수는 마차가 강화됨에 따라 점점 늘어난다.
      - 대기 슬롯 : 싣을수 있는 모든 화물이 표기 (인벤토리)
      - 보유 효과 표기 (화물로 인한 모든 보유효과 합산 표기)
      - 화물 소환 버튼 (상점으로 이동)
...
26) 여객 </br>      
      - 탑승 슬롯 : 마차에 탑승 한다. - 슬롯의 수는 마차가 강화됨에 따라 늘어난다.
      - 대기 슬롯 : 최대 9개 (인벤토리)
      - 여객은 보유 효과 없음 (탑승해야만 효과 발생)
