...
# Google AdMob
 <img src="image/Mediation6.png" width="100%"><br>
...
# Meta Audience (입찰만 받는다. 즉 광고 네트워크로만 가능하다는 뜻. 그러니 이건 메디에이션에서 제외)

-----------------------------------------------------------------------------------------------------------------------------------------------------------------

# MAX 
 <img src="image/Mediation7.jpg" width="100%"><br>
구조 - 워터폴 구조
...
# IronSource 
 <img src="image/Mediation8.png" width="100%"><br>
구조 - 워터폴 구조
...
결국 레전드 오브 슬라임은 아이언소스의 루나로부터 솔루션(분석)을 받아 수익이 올라갔다고 하는데 우리한테 적용이 될지는 알 수 없는 사실이다. 
