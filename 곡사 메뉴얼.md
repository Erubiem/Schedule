...
* <img src="https://github.com/sesiprojectTexasPostalUnion/PrivateTexasPostalUnionSchedule/blob/main/image/CurveShot_Image/Prefab_3.png">
    ...
    * Distance: 공의 목표 거리.
      * <p>
        <img src="https://github.com/sesiprojectTexasPostalUnion/PrivateTexasPostalUnionSchedule/blob/main/image/CurveShot_Image/01_거리_3.gif" style="width:30%; height:30%; float:left;">
        <img src="https://github.com/sesiprojectTexasPostalUnion/PrivateTexasPostalUnionSchedule/blob/main/image/CurveShot_Image/01_거리_5.gif" style="width:30%; height:30%; float:left;">
        </p>
    * Time: 목표 거리까지 소요될 시간
