...
* <img src="https://github.com/sesiprojectTexasPostalUnion/PrivateTexasPostalUnionSchedule/blob/main/image/CurveShot_Image/Prefab_3.png">
    ...
    * Distance: 공의 목표 거리.
      <p align="left">
        <img src="https://github.com/sesiprojectTexasPostalUnion/PrivateTexasPostalUnionSchedule/blob/main/image/CurveShot_Image/01_거리_3.gif"> Distance = 3 <img src="https://github.com/sesiprojectTexasPostalUnion/PrivateTexasPostalUnionSchedule/blob/main/image/CurveShot_Image/01_거리_5.gif" style="width:50%; height:50%;"> Distance = 5
      </p>
    * Time: 목표 거리까지 소요될 시간
